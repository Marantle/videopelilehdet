...
type AllMagazinePagesQueryVariables = Exact<{ [key: string]: never; }>;


type AllMagazinePagesQuery = { readonly allFile: { readonly nodes: ReadonlyArray<{ readonly name: string, readonly relativeDirectory: string, readonly large: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null, readonly small: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null }> } };
